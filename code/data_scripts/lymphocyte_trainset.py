...
def work(filepaths,savefolder,fldr,d_annot_index,image_id):
    ...
    for filepath in filepaths:
        ...
        d_stack=np.stack([image[0],image[3],image[4],image[5]])
...
def main():
    ...
    parser.add_argument(
        "--read",
        type=str,
        default='../test_images_nostruct',
        help=""
    )
    parser.add_argument(
        "--write",
        type=str,
        default='../Human_paraffin_single_stain_trainset_DC_L_try2',
        help=""
    )
    ...
    #load pkl file with patient IDs after splitting at patient level
    train_per=0.8
    val_per=0.1
